...
async def startup_event():
    ...
    # Pressure alert loop: fetch from TimescaleDB (same as /dashboard/extruder/latest) every 60s
    global _pressure_alert_task
    _pressure_alert_task = asyncio.create_task(pressure_alert_loop(interval_seconds=60))
